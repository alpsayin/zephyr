...
/* Flush the whole dcache */
extern void microblaze_flush_dcache(void);
/* Invalidate a part of the icache */
extern void microblaze_invalidate_icache_range(void *cacheaddr, int len);
/* Invalidate a part of the dcache */
extern void microblaze_invalidate_dcache_range(void *cacheaddr, int len);
/* Flush a part of the dcache */
extern void microblaze_flush_dcache_range(
	/* Scrub LMB and internal BRAM */ void *cacheaddr, int len);
extern void microblaze_scrub(void);
/* Invalidate cache ext */
extern void microblaze_invalidate_cache_ext(void);
/* Flush cache ext */
extern void microblaze_flush_cache_ext(void);
/* Flush cache ext range */
extern void microblaze_flush_cache_ext_range(void *cacheaddr, int len);
/* Invalidate cache ext range */
extern void microblaze_invalidate_cache_ext_range(void *cacheaddr, int len);
